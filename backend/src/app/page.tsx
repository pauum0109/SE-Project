  ...
  return (
    <main>
      ...
      <section className="w-full h-[520px] px-[170px] py-[60px] flex gap-[60px] items-center">
        ...
        <div className="flex-1 relative">
          <div className="h-[400px]">
            <Image src="/food.jpg" alt="food" fill className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full h-auto px-[170px] py-[60px] flex items-center gap-[60px]">
        <div className="flex-1 flex flex-col gap-6">
          <h2 className="text-black text-[40px] font-bold leading-[48px]">
            About us
          </h2>
          <p className="text-black text-base font-normal">
            Welcome to <span className="text-[#ff6868]">G</span>roup{" "}
            <span className="text-[#ff6868]">ATE</span>—your gateway to
            delicious, hassle-free dining! Our platform connects food lovers
            with top local restaurants, offering a seamless way to get food
            delivery.
          </p>
        </div>
